      ...
      this.timer = this.api
        ...
        .subscribe((res) => {
          ...
          if (res.type === HttpEventType.UploadProgress) {
            ...
            console.log(this.data.ITEM_IMAGE_URL,'this.data.ITEM_IMAGE_URL yhtr');
            ...
            if (res.body["code"] == 200) {
              ...
              console.log(this.data.ITEM_IMAGE_URL,'this.data.ITEM_IMAGE_URL');
              this.isSpinning = false;
              this.data.ITEM_IMAGE_URL = this.UrlImageOne;
            } else {
              console.log(this.data.ITEM_IMAGE_URL,'this.data.ITEM_IMAGE_URL');
            ...
            console.log(this.data.ITEM_IMAGE_URL,'this.data.ITEM_IMAGE_URL check');
