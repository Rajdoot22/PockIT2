...
export class AppLanguageDrawerComponent {
  ...
  save(addNew: boolean, LanguageDrawer: NgForm): void {
    ...
    if (
      ...
      this.data.JSON_URL == null ||
      this.data.JSON_URL == undefined ||
      this.data.JSON_URL == 0
    ) {
      this.isOk = false;
      this.message.error("Please Enter Json Url.", "");
    }
      ...
      this.timer = this.api
        ...
        .subscribe((res) => {
          ...
          if (res.type === HttpEventType.UploadProgress) {
            ...
            console.log(this.data.ICON, "this.data.ICON yhtr");
            ...
            console.log(this.data.ICON, "this.data.ICON check");
          }
        });
    } else {
