...
export class ServiceCatMasterDrawerComponent
{
  ...
  save(addNew: boolean, ServiceCatmaster: NgForm): void {
    ...
    //             console.log(this.data.SERVICE_IMAGE_URL,'this.data.SERVICE_IMAGE_URL');
    //             this.isSpinning = false;
    //             this.data.SERVICE_IMAGE_URL = this.UrlImageOne;
    ...
    this.timer = this.api
      ...
      .subscribe((res) => {
        ...
        if (res.type === HttpEventType.UploadProgress) {
          ...
          console.log(this.data.SERVICE_IMAGE_URL,'this.data.SERVICE_IMAGE_URL yhtr');
          ...
          console.log(this.data.SERVICE_IMAGE_URL,'this.data.SERVICE_IMAGE_URL check');
