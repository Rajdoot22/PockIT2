...
import { invetoryAdjustments } from "../../inventorymodal/inventoryAdjustment";
...
export class InventorymasterComponent {
  ...
  columns1: { label: string; value: string }[] = [
    ...
    { label: "Inventory Sub-Category", value: "Inventory Sub-Category" },
    { label: "Unit", value: "Unit Id" },
    { label: "Quantity", value: "Quantity" },
    { label: "Purchase Price", value: "Purchase Price" },
    { label: "Selling Price", value: "Selling Price" },
    { label: "Location", value: "Location Id" },
    { label: "Date of Entry", value: "Date of Entry" },
  ...
  showcolumn = [
    ...
    { label: "Unit", key: "UNIT_ID", visible: true },
    ...
    { label: "Location", key: "LOCATION_ID", visible: true },
    ...
    this.dataList = [
      {
        ...
        INVENTRY_SUB_CATEGORY: "Computer Accessories",
        UNIT: "Piece",
        QUANTITY: 150,
        PURCHASE_PRICE: 300,
        SELLING_PRICE: 450,
        LOCATION: "Warehouse A",
        DATE_OF_ENTRY: "2024-11-15",
        REMARKS: "New stock arrived, no damage",
        STATUS: "Available",
      }
    ];
